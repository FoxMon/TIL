...
class Map {
    ...
    public Map(int row, int col, int color) {
        this.row = row;
        this.col = col;
        this.color = color;
    }
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(makeMaze(0, 0));
    }

    public static int makeMaze(int tempRow, int tempCol) {
            ...
            for(int i = 0; i < 4; i++) {
                ...
                if(currentRow >= 0 && currentCol >= 0 && currentRow < size && currentCol < size) {
                    ...
                    if(map[currentRow][currentCol] == 1) {
                        ...
                        queue.offer(new Map(currentRow, currentCol, current.getColor()));
                    } else {
                        visited[currentRow][currentCol] = current.getColor() + 1;
                        queue.offer(new Map(currentRow, currentCol, current.getColor() + 1));
                    }
                }
            }
        }
