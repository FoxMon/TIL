...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < edge; i++) {
            ...
            students[first].add(new Student(last, time));
            studentsBack[last].add(new Student(first, time));
        }

        int[] results1 = findTime(students);
        int[] results2 = findTime(studentsBack);
        int result = 0;
    ...
    public static int[] findTime(ArrayList<Student>[] temp) {
